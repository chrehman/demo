...
function header() {
    return (
        <div>
            <div className='contact-header-outer-div'>
                <div className='header-logo-div'>
                    <img className='contact-header-logo' src={logo} alt='logo'/>
                </div>
                <div className='contact-features-btns-div'>
            ...
            <div className='contact-us-mobile-view-header'>
