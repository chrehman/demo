...
function Why_Us() {
    return (
        <div className='why-us-outer-div'>
            <span className='why-us-title'>WHY JOIN US ?<div className='why-us-title-underline'/></span>
            <div className='why-us-discription-div'>
            ...
            <div className='why-us-images row'>
                <div className='why-us-image-div col-4'>
                    <img className='why-us-image1' src={Img1} alt='img1'/>
                </div>
                <div className='why-us-image-div col-4'>
                    <img className='why-us-image2' src={Img2} alt='img2'/>
                </div>
                <div className='why-us-image-div col-4'>
                    <img className='why-us-image3' src={Img3} alt='img3'/>
                </div>
            </div>
        </div>
    )
